...
function findDefinition(type: string) {
  return [...blockLibrary.triggers, ...blockLibrary.actions].find(
    (block) => block.id === type,
  );
}
...
export function WorkflowBuilderPage() {
  ...
  return (
    <main className="flex h-screen flex-col overflow-hidden bg-gray-50 pt-16">
      ...
      <div className="relative flex min-h-0 flex-1">
        ...
        {/* Config panel */}
        {selectedBlock ? (
          <div className="fixed inset-y-0 right-0 z-40 w-[min(420px,100vw)] pt-[calc(4rem+3.5rem)] lg:relative lg:inset-auto lg:z-auto lg:w-[420px] lg:pt-0">
            <ConfigPanel
              block={selectedBlock}
